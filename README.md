...
For example, `./preprocess_meta.py` uses the predictions made by `SEQ` and `SpanPred`(generated by this framework) for GENIA, which are located in `./raw_data_for_meta/genia`, to prepare data for Meta.  
